     ...
     <div class="row">
      ...
      <div class ="container" style="background-color: #eff5f5;margin-left: 0px; margin-right: 0px;height:auto;width:auto;border-radius:20px" >
        ...
        <form action="" method="POST">
                ...
                <input type="number" class= "form-control" name="phone_number" id="" placeholder="Telephone Number" value="<?php if (isset($tel)) {echo $tel;
                }?>" style="width:600px;margin-top: 5px;" >
                ...
                <input type="number" class= "form-control" name="parent_tnumber" id="" placeholder="Telephone number of the parent or guardian" value="<?php if (isset($type)) {echo $type;
                }?>" style="width:600px;margin-top: 5px;" >
                <input type="email" class= "form-control" name="parent_email" id="" placeholder="Valid Email"   style="width:600px;margin-top: 5px;" >
                <input type="text" class= "form-control" name="siblings" id="" placeholder="If you have any siblings type their Age" style="width:600px;margin-top: 5px;" >
