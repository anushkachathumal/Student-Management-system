                    ...
                    <div class="">
                        ...
                        <form class="form-horizontal" method="post" action="reg_pdo.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input id="Sname" name="" type="text" placeholder="Student Name" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                                <div class="col-md-8">
                                    <input id="SID" name="" type="INT" placeholder="Student ID Number" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                   <font face="Tamaha" color=#0000ff>Select your Class</font>
                                </div>
                                <div class="col-md-6">
                                    <div class="radio">
                                        <label><input type="radio" name="" checked>Group</label>

                                        <label><input type="radio" name="">Mass</label>
                                    </div>
                                </div>
                            </div>
