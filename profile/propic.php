...
{ ?>
    ...
    <div class="user_profile_info gray-bg padding_4x4_40">
	  ...
	  <?php 
	  if(($result->path)){ ?>
	  <img  src="<?php echo ($result->path); ?>" alt="image" class="propic">  
	
	 <?php }
	  else { ?>
	<img src="assets/images/prof.png" alt="image" class="propic">
	 <?php }
	?>
	  <br><br>
      ...
      <div class="dealer_info">
		...
		<div class="form-group">
            ...
            <button type="button" style="margin-left:10px;"  onclick="document.location.href='profileTest.php'" class="btn">Back<span class="angle_arrow"><i class="fa fa-angle-left" aria-hidden="true"></i></span></button>
			</div>
          </form>
        </div>
      </div>
