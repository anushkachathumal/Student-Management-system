...
<?php }} ?>
    ...
    <div class="row">
      <div class="col-md-3 col-sm-3"><br><br><br><br><br>
...
$query->execute();
//echo "<script>alert('Successfully Update... ');window.location='profileTest.php'</script>";
...
{ ?>
			...
			<div class="form-group">
              ...
              <input placeholder="email@wisdom.com" pattern="^[-+.\w]{1,64}@[-.\w]{1,64}\.[-.\w]{2,6}$" class="form-control white_bg"  style="font-weight: bold;color:red;font-size:17px;"   value="<?php echo ($result->email);?>" name="emailid" id="email" type="email" required>
            </div>
