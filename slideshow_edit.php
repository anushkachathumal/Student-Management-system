				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="" ></a></li>
							<li><a href="" class="active">Edit Page</a>
...
<br><br>
<h1 style="width:40%;margin-left:300px;">You can change Only 3 Sliders</h1><br>
<form action="editslideaction.php" method="post" style="width:25%;margin-left:300px;" enctype="multipart/form-data">

<input type="file" name="img" class="form-control" alt="image" required><br>
<input type="submit" class="btn btn-primary" name="imgsave" value="save">
  ...
  <table class="table table-striped">
    <thead>
      <tr>
        ...
        <th style="font-size:20px;text-align:center">Image</th>
		<th style="font-size:20px;text-align:center">Delete</th>
      </tr>
    </thead>
	<?php
    ...
    echo "<tbody>
      <tr>";
       echo "<td style='text-align:center'>".$value['id']."</td>";
        echo "<td style='text-align:center'><img src=".$value['image']." width='200px;' height='100px;' alt='image'></td>";
				
				echo "<td style='text-align:center'><a href='editslideaction.php?id=$id' class='btn btn-warning' name='delete' >Delete</a><br><br><input type='button' value='Update' class='btn btn-primary'></td>
