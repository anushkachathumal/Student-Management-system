        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
					 ...
					 <ul class="nav navbar-nav navbar-right">
                         <li><a href="#" style="color:white;font-size:20px;"><span class="glyphicon glyphicon-user" style="color:white;"></span> <?php echo $username;?></a></li>
                        <li ><a href="logout.php" class="btn btn-info" style="color:white;font-size:20px;"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
    	...
    	<hr>
         <div class="panel panel-success">
          ...
          <form method="POST" action="">
            ...
            <input type="submit" name="comsave" id="save" class="btn btn-success pull-right" value="Comment">
          </form>
        </div>
    </div>
