		...
		<form action="MainAction.php" method="post">
					<table class="table">
						<tbody>
							...
							<tr>
								<td></td><td style="text-align:right"><button onclick="window.location.href = 'addTeacher.php';" type="submit" value="save" name="saveSubject" class="btn"><b>Save</b></button></td>
							</tr>
