				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="" ></a></li>
							<li><a href="" class="">Edit Page</a>
							<li><a href="" class="active">Create Add</a>
...
<h1>Answer Question</h1><br><br>
  ...
  <div class="form-group row">
      <div class="col-xs-4">
        <label for="f_id">Forum_ID :</label>
        <input class="form-control" id="ex1" type="text" required>
      </div>
      <div class="col-xs-4">
        <label for="st_id">Student_ID :</label>
    ...
    <br>
	<input type="submit" class="btn btn-primary btn-lg btn-block" style="width:px;height:px;" value="submit"><br> 
	<input type="reset" class="btn btn-secondary btn-lg btn-block" style="width:px;height:px;margin-left:px;"  value="Clear">
  </form>
</div>
</div>
<br><br>
